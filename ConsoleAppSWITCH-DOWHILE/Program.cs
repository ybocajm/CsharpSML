...
namespace ConsoleAppSWITCH_DOWHILE
{
	class Program
	{
...
// STEP 2 WHILE LOOP EDIT:  For the WHILE LOOP, I created this variable
			bool guessing = false;
			// STEP 3:  PUT DO in front of WHILE to ensure the loop runs at least once.
			do
			{
			...
			while (!guessing);
// STEP 3:  removed brackets for while loop
// STEP 3:  Now the DO will run, then the while loop hits
			Console.Read();
